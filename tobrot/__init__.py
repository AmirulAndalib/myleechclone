...
MAX_FILE_SIZE = 2136746229
TG_MAX_FILE_SIZE = 2136746229
FREE_USER_MAX_FILE_SIZE = 2136746229
...
DEF_THUMB_NAIL_VID_S = os.environ.get(
    "DEF_THUMB_NAIL_VID_S", "https://telegra.ph/file/4b029b680e727b2d9974a.png"
)
...
MAX_TG_SPLIT_FILE_SIZE = int(os.environ.get("MAX_TG_SPLIT_FILE_SIZE", "2136746229"))
...
def bcmds():
    ...
    BotCommand(f'{GET_SIZE_G}','Get The Size From Cloud'),
    BotCommand(f'{LOG_COMMAND}','Check The Logs')]
